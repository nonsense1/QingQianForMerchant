...
-(void)successStyle{
    ...
    [self setBackgroundImage:[self buttonImageFromColor:kColorBtnRed] forState:UIControlStateNormal];
    [self setBackgroundImage:[self buttonImageFromColor:[UIColor colorWithHexString:@"0xf61d4a" andAlpha:0.5]] forState:UIControlStateDisabled];
